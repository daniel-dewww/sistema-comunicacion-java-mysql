...
public class RegistroPadre extends javax.swing.JFrame {
  ...
  Metodos_Admin metodos = new Metodos_Admin();
    ...
    private void initComponents() {
        ...
        dfaf.setText("REGISTRAR PADRE");
        jPanel1.add(dfaf, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, -1, -1));
    ...
    private void aceptar() {
        ...
        String username = "p" + nombre.substring(0,2);
        String password = "p" + nombre.substring(0,2) + telefono.substring(0,2);
        String id =  "p" + username + telefono.substring(0,4);
        
        metodos.guardarPadre(id, nombre, username, password, direccion, email, telefono,  fecha, genero);
            if (id.equals("") || nombre.equals("") || username.equals("") || direccion.equals("") || email.equals("") || telefono.equals("") || fecha.equals("") || genero.equals("")) {
                JOptionPane.showMessageDialog(null, "Ingrese todos los campos");
            } else{
                AgregarHijoAlumno a = new AgregarHijoAlumno();
                a.lblId.setText(id);
                a.lblNombreC.setText(nombre);
                a.setVisible(true);
                this.dispose();
            }
